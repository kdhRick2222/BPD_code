...
class TrainDataset_bpd_multi_np(Dataset):
    def __init__(self, knnfile):
        super(TrainDataset_bpd_multi_np, self).__init__()
    ...
    def __getitem__(self, idx):
        traindata = self.x_train1 # torch.FloatTensor(self.x_train1[idx])
        labeldata = self.y_train1 - 1 # torch.FloatTensor(self.y_train1[idx]) - 1
...
class EvalDataset_bpd_multi_np(Dataset):
    def __init__(self, knnfile):
        super(EvalDataset_bpd_multi_np, self).__init__()
        self.knnfile = knnfile
    ...
    def __getitem__(self, idx):
        testdata = self.x_test1 # torch.FloatTensor(self.x_test1[idx])
        labeldata = self.y_test1 - 1 # torch.FloatTensor(self.y_test1[idx]) - 1
...
class TrainDataset_bpd_bi_np(Dataset):
    def __init__(self, knnfile, target):
        super(TrainDataset_bpd_bi_np, self).__init__()
        self.knnfile = knnfile
        self.target = target
...
class EvalDataset_bpd_bi_np(Dataset):
    def __init__(self, knnfile, target):
        super(EvalDataset_bpd_bi_np, self).__init__()
        self.knnfile = knnfile
        self.target = target
        self.df = pd.read_excel(self.knnfile)
        if self.target == 'bpd_bi1':
...
class TrainDataset_multi_rds_np(Dataset):
    def __init__(self, knnfile, target):
        super(TrainDataset_multi_rds_np, self).__init__()
        self.knnfile = knnfile
        self.target = target
...
class EvalDataset_multi_rds_np(Dataset):
    def __init__(self, knnfile, target):
        super(EvalDataset_multi_rds_np, self).__init__()
        self.knnfile = knnfile
        self.target = target
...
class TrainDataset_bi_rds_np(Dataset):
    def __init__(self, knnfile, target):
        super(TrainDataset_bi_rds_np, self).__init__()
        self.knnfile = knnfile
        self.target = target
...
class EvalDataset_bi_rds_np(Dataset):
    def __init__(self, knnfile, target):
        super(EvalDataset_bi_rds_np, self).__init__()
        self.knnfile = knnfile
        self.target = target
